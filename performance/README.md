...
- [Checking performance](#checking-performance)
	- [Browser developer tools](#browser-developer-tools)
		- [Simulating slower Internet](#simulating-slower-internet)
	- [Testing tools](#testing-tools)
- [Performance budgets](#performance-budgets)
	- [Example performance budget](#example-performance-budget)
...
![](readme-screenshots/network.jpg)
...
![](readme-screenshots/connection.jpg)
...
![](readme-screenshots/web-page-test.jpg)
...
![](readme-screenshots/pagespeed.jpg)
